...
AVAILABLE_STATS = [
    ...
    "flags.asked_hanami_concern",
    "flags.defended_laura",
    "flags.comforted_laura",
    "flags.asked_about_cassian",
    "flags.hanami_collapsed",
    "flags.hanami_truth_revealed",
    "flags.festival_day",
    "flags.club_shutdown_revealed",
    "flags.final_performance_decided",
    "flags.final_day",
    # Player state flags
    ...
    def __init__(self, workspace_rect, theme, project_root):
        ...
        self.sample_state = {
            ...
            "flags": {
                ...
                "act3_complete": False,
                # Scene-specific flags
                "asked_hanami_concern": False,
                "defended_laura": False,
                "comforted_laura": False,
                "asked_about_cassian": False,
                "hanami_collapsed": False,
                "hanami_truth_revealed": False,
                "festival_day": False,
                "club_shutdown_revealed": False,
                "final_performance_decided": False,
                "final_day": False,
            },
            "player": {
                "flags": {
